...
prompt = st.text_area("Enter your WebGoat-related question")
if st.button("Submit"):
    logging.info("[WebGoat] Prompt: " + prompt)
    if not prompt:
        ...
        with st.spinner("Contacting model..."):
            try:
                ...
                if response.status_code == 200:
                    ...
                    if st.button("🔊 Read aloud", key="read_response_webgoat"):
                        speak_text(output)
                else:
