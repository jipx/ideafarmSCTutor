...
prompt = st.text_area("Enter your cloud security-related question")
if st.button("Submit"):
    logging.info("[Cloud Security] Prompt: " + prompt)
    if not prompt:
        ...
        with st.spinner("Contacting model..."):
            try:
                ...
                if response.status_code == 200:
                    ...
                    if st.button("🔊 Read aloud", key="read_response_cloud"):
                        speak_text(output)
                else:
